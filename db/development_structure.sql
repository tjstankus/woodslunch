...
CREATE TABLE "payments" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "account_id" integer, "amount" decimal(5,2) DEFAULT 0, "notes" text, "created_at" datetime, "updated_at" datetime);
