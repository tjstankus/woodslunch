CREATE TABLE "account_invitations" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "account_request_id" integer, "token" varchar(255));
CREATE TABLE "account_requests" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar(255), "first_name" varchar(255), "last_name" varchar(255), "state" varchar(255), "approved_at" datetime, "declined_at" datetime, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "orders" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "served_on" date, "student_id" integer, "total" decimal(5,2) DEFAULT 0, "created_at" datetime, "updated_at" datetime);
