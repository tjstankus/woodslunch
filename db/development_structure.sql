...
CREATE TABLE "orders" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "served_on" date, "student_order_id" integer, "user_order_id" integer, "total" decimal(5,2) DEFAULT 0, "created_at" datetime, "updated_at" datetime);
...
CREATE TABLE "student_orders" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "starts_on" date, "ends_on" date, "student_id" integer, "created_at" datetime, "updated_at" datetime);
...
INSERT INTO schema_migrations (version) VALUES ('20110531120156');
