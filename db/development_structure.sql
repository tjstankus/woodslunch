...
CREATE TABLE "menu_items" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255), "description" text, "price" decimal(5,2), "created_at" datetime, "updated_at" datetime, "short_name" varchar(255), "inactive_starts_on" date DEFAULT NULL);
...
INSERT INTO schema_migrations (version) VALUES ('20111107114158');